  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row-fluid">
        ...
        <div class="span9">
          <h1>Frames Category</h1>
          <p>You can create your category frames here.</p>
            ...
            if($galleries){
              ...
              foreach($galleries as $gallery){
                echo '<tr>
                  <td>'.$gallery->id.'</td>
                  <td>'.$gallery->title.'</td>
                  <td>'.$gallery->frame()->count().'</td>
                  <td><a class="btn btn-primary" href="'.action('admin.frames_gallery@edit', array($gallery->id)).'">Edit</a> <a class="delete_toggler btn btn-danger" rel="'.$gallery->id.'">Delete</a></td>
                </tr>';
              }
              echo '</tbody></table>';
            }else{
          ...
          ?>
          <a href="<?php echo action('admin.frames_gallery@create')?>" class="btn btn-primary right">New Category</a>
        </div>
