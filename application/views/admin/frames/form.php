    ...
    <div class="container">
      ...
      <div class="row-fluid">
        ...
        <div class="span9 crud">
          ...
          <?php echo Form::open_for_files('admin/frames/'.( $create ? 'create' : 'edit' ), 'POST', array('class'=>'form-horizontal'));?>
          ...
          <fieldset>
            ...
            <div class="control-group">
              <?php echo Form::label('gallery_id', 'Belongs To Category',array('class'=>'control-label'))?>
              <div class="controls">
                <?php
                $dataset[''] = 'Please Select A Category';
                if($galleries){
            ...
            <div class="control-group">
              <?php echo Form::label('title', 'Frame Title',array('class'=>'control-label'))?>
              <div class="controls">
                <?php echo Form::text('title',  ( Input::old('title') || $create ? Input::old('title') : $image->title ),array('placeholder'=>'Enter Frame Title...'))?>
              </div>
            </div>
          ...
          <fieldset>
            <legend>Images</legend><br>
            <div class="row">
              <div class="span5">
                <div class="control-group">
                  <?php echo Form::label('image', 'Upload Frame',array('class'=>'control-label'))?>
                  <div class="controls">
          ...
          <div class="form-actions">
            <a class="btn" href="<?php echo url('admin/frames')?>">Go Back</a>
            <input type="submit" class="btn btn-primary" value="<?php echo ($create ? 'Create Frame' : 'Save Frame')?>" />
          </div>
          <?php echo Form::close()?>
        </div>
