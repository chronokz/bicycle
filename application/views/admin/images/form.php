        ...
        <div class="span9 crud">
          ...
          <fieldset>
            ...
            */
            ...
            <div class="control-group">
              <?php echo Form::label('gallery_images_relation[]', 'Belongs To Galleries',array('class'=>'control-label'))?>
              <div class="controls">
                <?php
                $dataset = array();
                if($galleries){
                ...
                echo Form::select('gallery_images_relation[]', $dataset, $create ? false : $gallery_values, array('multiple'=>'multiple', 'size'=>8) )?>
              </div>
            </div>            
            ...
            <div class="row">
              ...
              <div class="span3" style="clear:both">
                ...
                <ul class="thumbnails">
                  ...
                  <li>
                    <div class="thumbnail">
                      <img src="<?php echo asset(Image::$upload.$upload->small_filename)?>" alt="">
                      <div class="caption">
